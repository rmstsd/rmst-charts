...
export const getTransformAngleByMt = (transform: IMatrixArr, angleBase = { x: 0, y: -1 }) => {
  const tf = new Matrix(transform.a, transform.b, transform.c, transform.d, 0, 0)
  const angleVec = tf.apply(angleBase)
  return getSweepAngle(angleBase, angleVec)
}
...
// const ag = getTransformAngle([
//   0.8843737390504761, 0.4667794872076969, 8.326672684688677e-17, 1, -525.3817114432056, -103.79724265491016
// ])

// console.log(rad2deg(ag))
